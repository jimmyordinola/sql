USE [ERP_ECHA]
GO
/****** Object:  StoredProcedure [contabilidad].[USP_VOUCHER_DOCS_CONTABLE_SIN_ANEXO_4_ORIGINAL]    Script Date: 20/01/2026 12:29:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [contabilidad].[USP_VOUCHER_DOCS_CONTABLE_SIN_ANEXO_4_ORIGINAL]  
(    --ORIGINAL
@P_RUCE CHAR(11),  
@P_EJER CHAR(4),  
...
-- PRINT @L_CONSULTA  +  @L_CONSULTA2    
 PRINT @L_CONSULTA + @L_CONSULTA1 + @L_CONSULTA2   
