...
USE [ERP_ECHA]
GO
/****** Object:  StoredProcedure [contabilidad].[USP_VOUCHER_DOCS_CONTABLE_SIN_ANEXO_4]    Script Date: 13/01/2026 14:01:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [contabilidad].[USP_VOUCHER_DOCS_CONTABLE_SIN_ANEXO_4]  
(    
@P_RUCE CHAR(11),  
@P_EJER CHAR(4),  
...
select  
 ...
 LEN(ISNULL(v.Cd_Clt,'''') + ISNULL(v.Cd_Prv,'''') + ISNULL(v.Cd_Trab,'''')) > 0 and
 (v.Ejer + v.Prdo) BETWEEN ''' + @PeriodoDesde + ''' AND ''' + @PeriodoHasta + '''
 ' + case       
