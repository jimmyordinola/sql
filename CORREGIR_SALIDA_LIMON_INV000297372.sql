...
BEGIN TRY
    ...
    PRINT 'Si todo está correcto, ejecuta: COMMIT TRANSACTION'
    PRINT 'Si hay algún error, ejecuta: ROLLBACK TRANSACTION'
    PRINT ''
    ...
    -- =====================================================
    -- POR SEGURIDAD: NO HACER COMMIT AUTOMÁTICO
    -- Debes revisar los resultados y hacer COMMIT manualmente
    -- =====================================================
    PRINT '*** TRANSACCIÓN EN ESPERA ***'
    PRINT 'Ejecuta COMMIT TRANSACTION para confirmar'
    PRINT 'O ejecuta ROLLBACK TRANSACTION para cancelar'
